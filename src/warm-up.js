...
var sequel = `The sequel of ${title} is Where the Shrimp Sing!`;
...
console.log(" I could read that in a day and a half!");
  ...
  consol.log("Ok, maybe I could read that in a day and a half..");
}
...
var books = ["Crazy Rich Asians", "Dear Edward", "Nightingale", "To kill a Mockingbird", "Into Thin Air"];
...
var belowTwoHundred = [100, 150, 25, 50, 3, 7, 99, 80, 44, 47, 22, 60];
